...
VideoUnmask_SYSTEM_PROMPT = SYSTEM_PROMPT_with_DEMO.format(
    subgoals=subgoals,
...
VideoUnmask_SYSTEM_PROMPT_GROUNDED = SYSTEM_PROMPT_with_DEMO.format(
...
VideoUnmask_SYSTEM_PROMPT_ORACLE_PLANNER = SYSTEM_PROMPT_with_DEMO_ORACLE_PLANNER.format(
