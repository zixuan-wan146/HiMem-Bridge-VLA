...
class PerceptualVisualMemoryTests(unittest.TestCase):
    def test_compressor_accepts_non_square_visual_token_count(self):
        ...
        compressor = himem.PerceptualTokenCompressor(hidden_dim=8, memory_tokens=3, num_heads=2)
    ...
    def test_bottleneck_se_compressor_pools_square_visual_grid(self):
        ...
        compressor = himem.BottleneckSETokenCompressor(
            hidden_dim=8,
            memory_tokens=4,
            bottleneck_ratio=2,
        )
    ...
    def test_bottleneck_se_compressor_rejects_non_square_visual_grid(self):
        ...
        compressor = himem.BottleneckSETokenCompressor(hidden_dim=8, memory_tokens=4)
    ...
    def test_fixed_recent_memory_uses_r_half_and_r_offsets(self):
        ...
        memory = himem.FixedRecentVisualMemory(
            hidden_dim=8,
    ...
    def test_bank_stores_first_frame_and_returns_bridge_kwargs(self):
        ...
        memory = himem.PerceptualVisualMemoryBank(
            hidden_dim=8,
            memory_tokens=2,
            capacity=4,
            num_heads=2,
    ...
    def test_rejects_empty_valid_token_row(self):
        ...
        compressor = himem.PerceptualTokenCompressor(hidden_dim=8, memory_tokens=2, num_heads=2)
