...
def test_parse_action_response_accepts_horizon_prefix():
    message = json.dumps([[0, 1, 2, 3, 4, 5, 0.25, 99], [6, 7, 8, 9, 10, 11, 0.75]])
...
def test_parse_action_response_rejects_server_error():
    try:
        ...
        raise AssertionError("Expected server error payload to raise RuntimeError")
