...
from himem_bridge_vla.cli.eval import init_libero_experiment
import json
...
SCRIPT = REPO_ROOT / "scripts" / "eval" / "init_libero_experiment.py"
...
def test_create_experiment_writes_plan_manifest_profile_and_notes(tmp_path: Path):
    ...
    profile = "configs/runtime/libero_profiles/full_eval.env"
