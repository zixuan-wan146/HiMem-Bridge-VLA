...
from .path_utils import display_project_path, sanitize_project_paths
...
def build_reproducibility_metadata(config: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "bridge_himem_config_path": sanitize_project_paths(config.get("bridge_himem_config_path"), repo_root),
