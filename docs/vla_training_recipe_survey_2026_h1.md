...
1. `scripts/train/*`、`scripts/eval/*`、`scripts/serve/*` 可以存在，但权威参数应该来自 config/profile。
...
结合当前 HiMem-Bridge-VLA 的实际训练口径，文档应统一为：
...
1. `configs/training/stage1/libero/*.yaml`  
