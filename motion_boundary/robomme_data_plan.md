# RoboMME Data Plan For Motion Boundary

Date: 2026-06-16

## Decision

Use RoboMME before RoboCasa365 for the first `motion_boundary` training loop.

Reason: RoboMME H5 data contains direct subgoal boundary supervision:
...
The first adapter should export the current `motion_boundary` sidecar shape:
