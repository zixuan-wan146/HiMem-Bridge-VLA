...
REQUIRED_REPO_FILES = (
    ...
    "requirements.txt",
    "himem_bridge_vla/training_config.py",
    ...
    "scripts/inspect_benchmarks.py",
    "scripts/download_rmbench_tasks.py",
    ...
    "evaluations/rmbench/policy/HiMemBridgeVLA/deploy_policy.py",
    "evaluations/rmbench/policy/HiMemBridgeVLA/deploy_policy.yml",
