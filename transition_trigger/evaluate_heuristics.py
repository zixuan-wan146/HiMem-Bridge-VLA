...
from transition_trigger.data import TransitionTriggerDataset, build_datasets
from transition_trigger.evaluate import evaluate_record_scores
...
def evaluate_heuristics(dataset: TransitionTriggerDataset, config: dict[str, Any]) -> dict[str, Any]:
    raw_scores = {
        "low_recent_motion": [],
        "last_step_change": [],
        "jerk": [],
